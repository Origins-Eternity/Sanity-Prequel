...
@Mod(modid = Sanity.MOD_ID, name = Sanity.MOD_NAME, version = Sanity.VERSION, dependencies = "required-after:baubles@[1.5.2,);required-after:geckolib3@[3.0.30,);after:foodspoiling@[1.0.5,);")
public class Sanity {
